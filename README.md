...
Το παρόν λογισμικό διανέμεται υπό την άδεια χρήσης **MIT License**.  
Επιτρέπεται η ελεύθερη χρήση, τροποποίηση και διανομή του κώδικα για εκπαιδευτικούς και μη σκοπούς.
